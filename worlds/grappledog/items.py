...
item_data_table: Dict[str, GrappleDogItemData] = {
    "Gem": GrappleDogItemData(code=1,type=ItemClassification.useful | ItemClassification.skip_balancing, count=lambda world: world.options.minimum_gems_in_pool.value),
