...
item_data_table: Dict[str, GrappleDogItemData] = {
    ...
    "Bonus 1-1": GrappleDogItemData(code=111,type=ItemClassification.useful),
    "Bonus 1-2": GrappleDogItemData(code=112,type=ItemClassification.useful),
    "Bonus 1-3": GrappleDogItemData(code=113,type=ItemClassification.useful),
    "Bonus 1-4": GrappleDogItemData(code=114,type=ItemClassification.useful),
    ...
    "Bonus 2-1": GrappleDogItemData(code=211,type=ItemClassification.useful),
    "Bonus 2-2": GrappleDogItemData(code=212,type=ItemClassification.useful),
    "Bonus 2-3": GrappleDogItemData(code=213,type=ItemClassification.useful),
    "Bonus 2-4": GrappleDogItemData(code=214,type=ItemClassification.useful),
    ...
    "Bonus 3-1": GrappleDogItemData(code=311,type=ItemClassification.useful),
    "Bonus 3-2": GrappleDogItemData(code=312,type=ItemClassification.useful),
    "Bonus 3-3": GrappleDogItemData(code=313,type=ItemClassification.useful),
    "Bonus 3-4": GrappleDogItemData(code=314,type=ItemClassification.useful),
    ...
    "Bonus 4-1": GrappleDogItemData(code=411,type=ItemClassification.useful),
    "Bonus 4-2": GrappleDogItemData(code=412,type=ItemClassification.useful),
    "Bonus 4-3": GrappleDogItemData(code=413,type=ItemClassification.useful),
    "Bonus 4-4": GrappleDogItemData(code=414,type=ItemClassification.useful),
    ...
    "Bonus 5-1": GrappleDogItemData(code=511,type=ItemClassification.useful),
    "Bonus 5-2": GrappleDogItemData(code=512,type=ItemClassification.useful),
    "Bonus 5-3": GrappleDogItemData(code=513,type=ItemClassification.useful),
    "Bonus 5-4": GrappleDogItemData(code=514,type=ItemClassification.useful),
    ...
    "Bonus 6-1": GrappleDogItemData(code=611,type=ItemClassification.useful),
    "Bonus 6-2": GrappleDogItemData(code=612,type=ItemClassification.useful),
    "Bonus 6-3": GrappleDogItemData(code=613,type=ItemClassification.useful),
}
