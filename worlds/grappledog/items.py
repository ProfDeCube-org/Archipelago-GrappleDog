...
item_data_table: Dict[str, GrappleDogItemData] = {
    "Gem": GrappleDogItemData(code=1,type=ItemClassification.progression_skip_balancing, count=lambda world: 190),
    ...
    "Grapple Hook": GrappleDogItemData(code=10,type=ItemClassification.progression, can_create=lambda world: world.options.movement_rando.value),
    ...
    "World 1": GrappleDogItemData(code=21,type=ItemClassification.progression, can_create=lambda world: world.options.level_progression.value != 0),
    "World 2": GrappleDogItemData(code=22,type=ItemClassification.progression, can_create=lambda world: world.options.level_progression.value != 0),
    "World 3": GrappleDogItemData(code=23,type=ItemClassification.progression, can_create=lambda world: world.options.level_progression.value != 0),
    "World 4": GrappleDogItemData(code=24,type=ItemClassification.progression, can_create=lambda world: world.options.level_progression.value != 0),
    "World 5": GrappleDogItemData(code=25,type=ItemClassification.progression, can_create=lambda world: world.options.level_progression.value != 0),
    "World 6": GrappleDogItemData(code=26,type=ItemClassification.progression, can_create=lambda world: world.options.level_progression.value != 0),

    "Bounce Pads": GrappleDogItemData(code=31,type=ItemClassification.progression, can_create=lambda world: world.options.movement_rando.value),
    "Balloons": GrappleDogItemData(code=32,type=ItemClassification.progression, can_create=lambda world: world.options.movement_rando.value),
    "Cannons": GrappleDogItemData(code=33,type=ItemClassification.progression, can_create=lambda world: world.options.movement_rando.value),
    "Carrots": GrappleDogItemData(code=34,type=ItemClassification.progression, can_create=lambda world: world.options.movement_rando.value),
    "Wall Jump": GrappleDogItemData(code=35,type=ItemClassification.progression, can_create=lambda world: world.options.movement_rando.value),
    "Climb": GrappleDogItemData(code=36,type=ItemClassification.progression, can_create=lambda world: world.options.movement_rando.value),
    ...
    "Swim": GrappleDogItemData(code=38,type=ItemClassification.progression, can_create=lambda world: world.options.movement_rando.value),
    "Slam": GrappleDogItemData(code=39,type=ItemClassification.progression, can_create=lambda world: world.options.movement_rando.value),
