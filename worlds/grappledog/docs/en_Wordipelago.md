...
## Objective
#### Goals
GrappleDog supports two main goal types:
...
## Technical Details
**GrappleDog** is implemented in JavaScript and works in all modern HTML5-capable browsers. The game state is automatically saved and synchronized across devices, allowing you to switch machines or play with multiple clients without issues or losing progress.
